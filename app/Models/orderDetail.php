...
class orderDetail extends Model
{
    ...
    protected $fillable = [
        'order_id','affiliate_id','qty','price','tax','shipping','inventory_id','sku','productName','productDescription','variation0','variation1','variation2','variation3','variation4','imageURL0','imageURL1','imageURL2','imageURL3','imageURL4','imageURL5','videoURL','pdfURL','status','offerDescription'
    ];
