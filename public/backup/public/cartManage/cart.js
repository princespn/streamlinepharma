...
function updateCart(cartTempId,buttonAction) {

    var qty = document.getElementById("qty"+cartTempId).value;
    var csrfToken= document.getElementById("csrfToken").value;
    
    const param = { "id":cartTempId,"qty" : qty,"buttonAction" : buttonAction };
...
function updateRegister(){
    ...
    const param = {"name":name,"phone":phone,"email":email,"landmark":landmark,"address":address,"zipCode":zipCode };
