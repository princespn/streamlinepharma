...
<div class="row">
    <div class="col-12">
		...
		<div class="card m-b-20">
            ...
            <div class="card-body">
			  {!! Form::open(['url' => 'admin/upload_logo', 'files' => true]) !!}
			      Current : <image src='{{ url($account->logo) }}' width='150'>
				  ...
				  <div class="form-group">
					...
					<textarea type="text" name='address' class="form-control" id="address">{{ $account->address }}</textarea>
				  </div>
				  <div class="form-group">
					<label for="title">Company Name:</label>
					<input type="text" name='title' class="form-control" id="title" value='{{ $account->title }}'>
				  </div>
