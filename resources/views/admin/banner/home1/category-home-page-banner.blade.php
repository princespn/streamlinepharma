...
@if($type=='Home5-subCategory') Sub Category Home Page Banner @else Category Home Page Banner @endif</h4>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card m-b-20">
		    <div class="card-header">@if($type=='Home5-subCategory') Sub Category Home Page Banner @else Category Home Page Banner @endif</div>
            <div class="card-body">
			@if (session('status'))
		    ...
		    @endif
			@if( (count($data)<3&&$type!='Home5-subCategory') || (count($data)<4&&$type=='Home5-subCategory')  )
			{!! Form::open(['url' => 'admin/category-home-page-banner','class'=>'']) !!}
