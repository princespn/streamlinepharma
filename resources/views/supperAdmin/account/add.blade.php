        ...
        <div class="col-12">
            ...
            <div class="card m-b-20">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'account.store','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <input type="file" name="logo" class="form-control" required style="font-size: 11px;"> --}}
