		...
		<table width='100%'>
			...
			<tr style='background: #FFFF;'>
				<td colspan='2' style='padding: 2% !important;border-top: 10px solid grey;'>
					...
					<h1>Hello Sir,please recharge my accoount</h1>

					<span style='font-size:20px;'>
						<b>Request Domain</b> : {{$data['account']['title']}} <br>
						<b>Payment Mode</b> : {{$data['input']['paymentMode']}} <br>
						<b>Amount</b> : Rs {{$data['input']['paymentAmount']}} <br>
						<b>Date</b> : {{$data['input']['paymentDate']}}
					</span>
