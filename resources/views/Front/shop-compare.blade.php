                        ...
                        <table class="table text-center table-compare">
                            <tbody>
                                <tr class="pr_image">
                                    ...
                                    <td class="row_img"><img src="{{url('front_assets/imgs/shop/product-2-1.jpg')}}" alt="compare-img" /></td>
                                    <td class="row_img"><img src="{{url('front_assets/imgs/shop/product-1-1.jpg')}}" alt="compare-img" /></td>
                                    <td class="row_img"><img src="{{url('front_assets/imgs/shop/product-3-1.jpg')}}" alt="compare-img" /></td>
                                </tr>
                                <tr class="pr_title">
