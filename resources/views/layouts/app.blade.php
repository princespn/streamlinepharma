...
<html>
   ...
   <body>
      ...
      @if( !isset($_REQUEST['ph']) || $_REQUEST['ph']!='true')
      <div class="header-bg">
         <header id="topnav">
                     ...
                     <ul class="list-inline float-right mb-0">
                        <li class="list-inline-item dropdown notification-list">
                           ...
                           <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                              ...
                              <a class="dropdown-item" href="{{ url('admin/home-page-setting') }}"><i class="dripicons-card text-muted"></i>Homepage</a>
                              ...
                              <a class="dropdown-item" href="{{ url('admin/profile') }}"><i class="dripicons-card text-muted"></i> Profile</a>
                              <a class="dropdown-item" href="{{route('changePassword.index')}}"><i class="dripicons-lock text-muted"></i> Change Password</a>
                              <div class="dropdown-divider"></div>
                              @endif
                              @endif
                              @if(Session::get('userType') == 2)
                              <a class="dropdown-item" href="{{ url('admin/bank-detail') }}"><i class="dripicons-lock text-muted"></i>Bank Details</a>
                              @endif
                              
                              <a class="dropdown-item" href="{{ url('admin/logOut') }}"><i class="dripicons-exit text-muted"></i> Logout</a>
                           </div>
                        </li>
                  ...
                  <div id="navigation">
                     <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              <li>
                                 <a href="{{url('admin/view_advance_product')}}">Product Approval</a>
                              </li>
                              <li>
                        ...
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              ...
                              <li>
                                 <a href="{{url('admin/advance_order')}}">Advance Product Order</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/advance_product_template')}}">Advance Product Template</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/view_advance_product_template')}}">View Advance Product Template</a>
                              </li>
                           </ul>
                        </li>
                        <!--
                        ...
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              <li>
                                 <a href="{{url('admin/create_employee')}}">Create / View</a>
                              </li>
                           </ul>
                        </li>
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              <li>
                                 <a href="{{url('admin/add_description')}}">Add Desciption</a>
                              </li>
                           </ul>
                        </li>
						<li class="has-submenu">
                           ...
                           <ul class="submenu">
							  ...
							  <li>
                                 <a href="{{url('admin/services-variant')}}">Services Variant</a>
                              </li>
							  <li>
                                 <a href="{{url('admin/service-provider')}}">Service Provider</a>
                              </li>
                           </ul>
                        </li>
                        @else
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              <li>
                                 <a href="{{ url('admin/in_cart') }}">In Cart</a>
                              </li>
                              <li>
                                 <a href="{{ url('admin/advance_order') }}">Orders</a>
                              </li>
                              <li>
                        ...
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              ...
                              <li>
                                 <a href="{{ url('admin/memeber_list') }}">Member's List</a>
                              </li>
                           </ul>
                        </li>
                        <li class="has-submenu">
                        ...
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
							  ...
							  <li>
                                 <a href="{{url('admin/product-discount-offer')}}">Product Discount Offer</a>
                              </li>
                              <li>
                                 <a href="{{route('offers.index')}}">Purchase Offer</a>
                              </li>
                              <li>
                                 <a href="{{ url('admin/referral_scheme') }}">Referral Scheme</a>
                              </li>
                              <li>
                                 <a href="{{ url('admin/four_sale_x') }}">Sale X</a>
                              </li>
                           </ul>
                        </li>
                        <!--li class="has-submenu">
                        ...
                        <li class="has-submenu">
                           ...
                           <ul class="submenu">
                              ...
                              <li>
                                 <a href="{{route('faq.index')}}">Special Pages</a>
                              </li>
                              <li>
                                 <a href="{{route('msg.index')}}">SMS Notifications Management</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/page_detail')}}">Dynamic Name</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/referral_scheme_page')}}">Referral Scheme Page</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/membership')}}">Membership Program</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/razorpay_plan')}}">Razor Pay Subscription</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/advance_product_subscription')}}">Advance Product Teplate Subscription</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/brand')}}">Brand Management</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/register_users_listing_coloumn')}}">Register Users listing Coloumn</a>
                              </li>
                           </ul>
                        </li>
						<li class="has-submenu">
                           <a href="{{ url('admin/reviews') }}"><i class="dripicons-device-desktop"></i>Reviews</a>
                        </li>
                        <li class="has-submenu">
						   ...
						   @endphp
						      <li>
                                 <a href="{{url('admin/home-page-slider')}}">{{ $home_banner[$account->home_page] }}</a>
                              </li>
						   @if($account->home_page==7)
						      <li>
                                 <a href="{{url('admin/category-icon')}}">Category Icon</a>
                              </li>
						   @endif
						   @if($account->home_page==1||$account->home_page==7)
                              
                              <li>
                                 <a href="{{url('admin/category-home-page-banner')}}">Category Home Page Banner</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/daily-best-sell-banner')}}">Daily Best Sell Banner</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/deals-of-the-day')}}">Deals of the Day</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/home-page-lower-slide')}}">Home Page Lower Slide</a>
                              </li>
							@elseif($account->home_page==2)
							  	
							  <li>
                                 <a href="{{url('admin/home-page-slider-left/Right')}}">Home Page Slider - Right</a>
                              </li>	
							  <li>
                                 <a href="{{url('admin/category-home-page-banner')}}">Category Home Page Banner</a>
                              </li>
							...
							@else
							  ...
							  <li>
                                 <a href="{{url('admin/home-page-slider-left/RightUpper')}}">Home Page Slider - Right Upper</a>
                              </li>
                              <li>
                                 <a href="{{url('admin/home-page-slider-left/RightBottom')}}">Home Page Slider - Right Bottom</a>
                              </li>
							  <li>
                                 <a href="{{url('admin/sub-category-home-page-banner/sub-cat')}}">Home Page Sub Category</a>
                              </li>							  
							  @endif
							  <li>
                                 <a href="{{url('admin/deals-of-the-day')}}">Deals of the Day</a>
							...
							@endif
							   <li>
                                 <a href="{{url('admin/footer-slide')}}">Footer Slider</a>
                              </li>
                           </ul>
                        </li>
                        @endif
	...
	var saveData = $.ajax({
		  type: 'GET',
		  url: "{{ url('admin/checkSmsSetting') }}/"+id,
		  dataType: "text",
