...
<h4 class="page-title"> <i class="dripicons-calendar"></i><?php if($type=='Home1'||$type=='Home2'): ?> Daily Best Sell Banner <?php else: ?> Home Page Slider - <?php echo e($type); ?> <?php endif; ?></h4>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card m-b-20">
		    <div class="card-header"><?php if($type=='Home1'||$type=='Home2'): ?> Daily Best Sell Banner <?php else: ?> Home Page Slider - <?php echo e($type); ?> <?php endif; ?></div>
            <div class="card-body">
		    ...
		    <?php endif; ?>
			<?php if(count($data)<1): ?>
			<?php echo Form::open(['url' => 'admin/daily-best-sell-banner','class'=>'']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/admin/banner/home1/daily-best-sell-banner.blade.php ENDPATH**/ ?>