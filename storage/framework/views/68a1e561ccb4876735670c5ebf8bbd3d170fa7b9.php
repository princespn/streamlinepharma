...
<div class="float-right">
  ...
  <a class="btn btn-outline-light" href="<?php echo e(url('admin/view_employee')); ?>">View Employee</a>
...
<div class="row">
   <div class="col-12">
      <div class="card m-b-20">
		...
		<?php endif; ?>
		   <?php echo Form::open(['url' => url('admin/set_employee'), 'class' => '', 'id' => 'give_permission']); ?>
           ...
           <div class="form-group">
				...
				<select class="form-control" name="assigned_to" id="assigned_to" required>
					...
					<?php $__currentLoopData = $emp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empvalue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option value="<?php echo e($empvalue->id); ?>"><?php echo e($empvalue->title); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/admin/employee/create_employee.blade.php ENDPATH**/ ?>