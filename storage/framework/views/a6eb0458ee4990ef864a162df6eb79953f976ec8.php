    ...
    <div class="col-6">
        <div class="card m-b-20">
            ...
            <div class="card-body">
				...
				<?php endif; ?>
                <?php echo Form::open(['url' => 'admin/referral_scheme_page','method'=>'POST','id'=>'form']); ?>
                ...
                <?php echo e(csrf_field()); ?>
				  ...
				  <div class="form-group">
					...
					<input type='text' readonly <?php if(isset($mem_data)): ?> value='<?php echo e($mem_data->image); ?>' <?php endif; ?> class='form-control' name='image' id='image123' onclick="openImagePopup('123')">
				  </div>
				  ...
				  <?php if(count($data)): ?>
					  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					    <tr>
						   ...
						   <td><img width='80' src="<?php echo e(url($row->image)); ?>"></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/admin/offers/referral/referral_scheme_page.blade.php ENDPATH**/ ?>