                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post">
											...
											<p><a href="<?php echo e(url('forogot-password')); ?>">Click here to login or create new account.</a></p>
                                        </form>
                                    </div>
                                </div>
                            </div>
...
function initiateForgotPassoword(){
	...
	var saveData = $.ajax({
		  type: 'POST',
		  url: "<?php echo e(url('forgot_password_otp_genrate')); ?>",
		  data: myKeyVals,
		  dataType: "text",
...
function submitNewForgotPassoword(){
	...
	var saveData = $.ajax({
		  type: 'POST',
		  url: "<?php echo e(url('submitNewForgotPassoword')); ?>",
		  data: myKeyVals,
		  dataType: "text",
		  success: function(data){ 
		     data = JSON.parse(data);
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('FrontEndTheme.Nest.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/FrontEndTheme/Nest/forogot-password.blade.php ENDPATH**/ ?>