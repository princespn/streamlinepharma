...
<div class="float-right">
  ...
  <a class="btn btn-outline-light" href="<?php echo e(url('admin/view_referral_scheme')); ?>">View</a>
...
<div class="row">
   <div class="col-12">
      <div class="card m-b-20">
		...
		<?php endif; ?>
		   <?php echo Form::open(['url' => url('admin/referral_scheme'), 'class' => '']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/admin/offers/referral/index.blade.php ENDPATH**/ ?>