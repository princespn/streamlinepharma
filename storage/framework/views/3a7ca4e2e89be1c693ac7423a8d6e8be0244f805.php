<?php $__env->startSection('pageTitle'); ?>
    ...
    <h4 class="page-title"> <i class="dripicons-toggles"></i> Add slider</h4>
        ...
        <div class="col-12">
            ...
            <div class="card m-b-20">
                ...
                <div class="card-body">
                    ...
                    <?php echo Form::open(['route' => 'slider.store','method'=>'POST','id'=>'form','enctype'=>'multipart/form-data']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" onchange="validateImageUrl(1)" name="imageURL" id="image1" class="form-control" required/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/admin/product/slider/add.blade.php ENDPATH**/ ?>