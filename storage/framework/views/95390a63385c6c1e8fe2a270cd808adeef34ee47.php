...
<h4 class="page-title"> <i class="dripicons-calendar"></i>Category Icon</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card m-b-20">
		    <div class="card-header">Category Icon</div>
            <div class="card-body">
		    ...
		    <?php endif; ?>
			<?php echo Form::open(['url' => 'admin/category-icon','class'=>'']); ?>
		...
		<div class="card m-b-20">
            ...
            <div class="card-body">
			  ...
			  <?php echo Form::open(['url' => 'admin/home-banner-action','id'=>'deleteBanner']); ?>
			     ...
			     <input type='hidden' name='banner_type' value='6' >
			  <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/uniqueandcommon.com/public_html/globle_panel/public/new/resources/views/admin/banner/home1/category-icon.blade.php ENDPATH**/ ?>